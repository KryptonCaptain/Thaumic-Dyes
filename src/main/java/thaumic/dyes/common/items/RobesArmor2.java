...
import thaumic.dyes.client.models.ModelPraetor;

public class RobesArmor2 extends ItemArmor implements IRepairable, IRunicArmor, IVisDiscountGear, IGoggles, IRevealer, ISpecialArmor {
   ...
   public RobesArmor2(ArmorMaterial enumarmormaterial, int j, int k) {
   ...
   public void registerIcons(IIconRegister ir) {
      this.iconHelm = ir.registerIcon("thaum:phelmover");
      this.iconHelmOver = ir.registerIcon("thaum:phelm");
      this.iconBlank = ir.registerIcon("thaum:blank");
      this.iconChest = ir.registerIcon("thaum:pchestover");
      this.iconLegs = ir.registerIcon("thaum:plegsover");
      this.iconChestOver = ir.registerIcon("thaum:pchest");
      this.iconLegsOver = ir.registerIcon("thaum:plegs");
   }

   public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
      return type == null?"thaum:textures/models/armor/praeter_armor_overlay.png":"thaum:textures/models/armor/praeter_armor.png";
   }
