...
import thaumic.dyes.client.models.ModelRobes;

public class RobesArmor extends ItemArmor implements IRepairable, IRunicArmor, IVisDiscountGear, IGoggles, IRevealer, ISpecialArmor, IWarpingGear {
   ...
   public RobesArmor(ArmorMaterial enumarmormaterial, int j, int k) {
   ...
   public void registerIcons(IIconRegister ir) {
      this.iconHelm = ir.registerIcon("thaum:crimrobehelm");
      this.iconBlank = ir.registerIcon("thaum:blank");
      this.iconChest = ir.registerIcon("thaum:crimrobechestover");
      this.iconLegs = ir.registerIcon("thaum:crimrobelegsover");
      this.iconChestOver = ir.registerIcon("thaum:crimrobechest");
      this.iconLegsOver = ir.registerIcon("thaum:crimrobelegs");
   }

   public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
      return type == null?"thaum:textures/models/armor/crim_robe_armor_overlay.png":"thaum:textures/models/armor/crim_robe_armor.png";
   }
