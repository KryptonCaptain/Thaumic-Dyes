...
import thaumic.dyes.client.models.ModelKnight;

public class KnightArmor extends ItemArmor implements IRepairable, IRunicArmor, IVisDiscountGear, IGoggles, IRevealer, ISpecialArmor {
   ...
   public void registerIcons(IIconRegister ir) {
      this.iconHelm = ir.registerIcon("thaum:cultistplatehelmover");
      this.iconHelmOver = ir.registerIcon("thaum:cultistplatehelm");
      this.iconBlank = ir.registerIcon("thaum:blank");
      this.iconChest = ir.registerIcon("thaum:cultistplatechestover");
      this.iconLegs = ir.registerIcon("thaum:cultistplatelegsover");
      this.iconChestOver = ir.registerIcon("thaum:cultistplatechest");
      this.iconLegsOver = ir.registerIcon("thaum:cultistplatelegs");
   }

   public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
      return type == null?"thaum:textures/models/armor/cultist_plate_armor_overlay.png":"thaum:textures/models/armor/cultist_plate_armor.png";
   }
